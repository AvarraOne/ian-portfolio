...
en: {
  ...
  heroDesc:"Sales and business development leader with 12+ years driving revenue across APAC, North America, the Middle East, UK, and Australia. Delivered 40% revenue growth at Novatech, built the UAE market pipeline from zero at Medvocation, and managed 50+ concurrent mandates in investment banking. Specialist in enterprise deal origination, C-suite relationship management, and multi-market pipeline execution.",
  openToWork:'Open to Work · Available Now', btnViewExp:'View Experience',
  stats:['YoY Revenue Growth','Client Base Expansion','Concurrent Mandates','Years Experience'],
  ...
  storyTitle:'My Story',
  expTitle:'Work History', expSub:'Five roles across investment banking, SaaS, healthcare staffing, and outsourcing. Full details in the CV.',
  ...
  wt:['YoY Revenue Growth','Pipeline Forecast Accuracy','Client Base Expansion','Conversion Rate Improvement','Global Client Base Doubled','Deal Size Range','Account Value Growth','Enterprise Account Budgets'],
  wd:['Drove 40% year-over-year growth at Novatech through targeted outbound and strategic account planning across Fortune 1000 companies.','Maintained 85%+ accuracy across a 50+ account portfolio at CP Partners using Salesforce CRM.','Grew the Canadian healthcare client base by 50% in 18 months at Medvocation through LinkedIn outreach and referral programs.','Improved lead-to-client conversion by 35% by redesigning the sales funnel and using data to remove friction points.','Doubled Virtual Workforce Partners\' global client base within 2 years through multi-channel outbound across 5 markets.','Qualified and managed investment banking mandates from $5M to $100M+ covering M&A, capital advisory, and fundraising.','Grew average account value by 25% at Novatech through structured upsell and cross-sell programmes across Fortune 1000 and mid-market enterprise clients.','Managed enterprise client accounts with budgets ranging from $100K to $2M, handling full account lifecycle from onboarding to renewal.'],
...
zh: {
  ...
  heroDesc:'具有12年以上经验的销售与业务拓展领导者，在亚太区、北美、中东、英国和澳大利亚跨市场驱动营收增长。在Novatech实现40%营收增长，在Medvocation从零建立中东市场管道，并在投资银行业务中管理50+并发委托项目。专注于企业级交易开发、高管层关系管理及多市场管道执行。',
  openToWork:'正在求职 · 随时可入职', btnViewExp:'查看经历',
  stats:['年度营收增长','客户基础扩张','并发委托数量','年从业经验'],
  nav:['亮点成就','工作经历','市场区域','联系我'],
  winsTitle:'核心数据', winsSub:'12年真实岗位的可验证成果。',
  storyTitle:'我的故事',
  expTitle:'工作经历', expSub:'横跨投资银行、SaaS、医疗招聘及外包的五段经历。详情见简历。',
  ...
  wt:['年度营收增长','管道预测准确率','客户基础扩张','转化率提升','全球客户翻倍','交易规模范围','客户价值增长','企业客户预算'],
  wd:['通过有针对性的外向销售和战略客户规划，在Novatech实现了40%的年度营收增长，覆盖财富1000强企业。','在CP Partners使用Salesforce CRM，在50+个客户组合中维持了85%以上的预测准确率。','通过LinkedIn拓展和转介绍计划，在18个月内将Medvocation的加拿大医疗客户群增长了50%。','通过重新设计销售漏斗并利用数据消除摩擦点，将潜在客户到签约客户的转化率提升了35%。','通过5个市场的多渠道外向销售，在两年内将Virtual Workforce Partners的全球客户群翻倍。','资格审核并管理了从500万到1亿美元以上的投资银行授权业务，涵盖并购、资本顾问和融资。','通过结构化的增值销售和交叉销售计划，在Novatech将财富1000强和中端市场企业客户的平均账户价值提升了25%。','管理预算从10万到200万美元的企业客户账户，负责从入职到续约的完整客户生命周期管理。'],
  ...
  er:['商务拓展经理','商务拓展与客户经理','国家销售与业务拓展经理','项目经理与商务拓展总监','销售与业务拓展主管'],
  ex:['构建并管理了价值500万至1亿美元以上授权业务的50+潜在客户管道。推动了与科技、医疗和金融服务行业的创始人、CEO和CFO的C级高管接触。使用Salesforce CRM保持85%以上的预测准确率。','通过针对财富1000强和中端市场企业的外向销售，实现了40%的年度营收增长。实现了85%以上的客户留存率，并通过结构化增值销售计划将平均客户价值提升了25%。','在18个月内将加拿大客户群扩大了50%。通过重新设计销售漏斗，提升转化率35%。同时从零开始建立阿联酋销售管道，并负责全加拿大营收管理。','在两年内，在英国、美国、澳大利亚、阿联酋和亚太地区将全球客户群翻倍。跨时区带领跨职能交付团队，管理预算从10万到200万美元的企业客户账户。建立了产生持续性收入的转介绍网络，同时在多个同步客户项目中完成全程项目管理。','实现了20%的年度销售增长，并将商家合作伙伴关系增长了30%。指导了一个5人初级销售团队达到100%的KPI目标，将团队成交率提升了15%。'],
...
ja: {
  ...
  heroDesc:'12年以上のキャリアを持つ営業・事業開発リーダーとして、APAC・北米・中東・英国・オーストラリアで収益成長を牽引。Novateachで40%の収益成長を達成し、Medvocationでアラブ首長国連邦市場をゼロから構築、投資銀行業務では50件以上の同時案件を管理。企業案件開発、経営幹部との関係構築、マルチマーケット戦略を専門とする。',
  openToWork:'転職活動中 · 即入社可能', btnViewExp:'経歴を見る',
  stats:['年間収益成長率','顧客基盤拡大率','同時案件数','経験年数'],
  nav:['実績','職歴','市場','お問い合わせ'],
  winsTitle:'重要な数字', winsSub:'12年間の実際の職歴から検証済みの成果。',
  storyTitle:'私のストーリー',
  expTitle:'職歴', expSub:'投資銀行、SaaS、医療スタッフィング、アウトソーシングにわたる5つの職歴。詳細はCVをご覧ください。',
  ...
  wt:['年間収益成長率','パイプライン予測精度','顧客基盤拡大','コンバージョン率向上','グローバル顧客基盤の倍増','案件規模','アカウント価値成長率','エンタープライズアカウント予算'],
  wd:['ターゲット型アウトバウンドと戦略的アカウントプランニングを通じて、NovateachでフォーチュンFortune 1000企業に対し40%の年間成長を達成。','CP PartnersでSalesforce CRMを使い、50以上のアカウントポートフォリオで85%以上の予測精度を維持。','Medvocationで、LinkedInアウトリーチと紹介プログラムを通じて、18か月でカナダの医療顧客基盤を50%拡大。','セールスファネルを再設計し、データを活用してフリクションポイントを排除することで、リードから顧客への転換率を35%向上。','5市場にわたるマルチチャネルアウトバウンドにより、2年以内にVirtual Workforce Partnersのグローバル顧客基盤を2倍に。','M&A、資本アドバイザリー、資金調達をカバーする500万ドルから1億ドル超の投資銀行マンデートを資格審査・管理。','構造化されたアップセルとクロスセルプログラムにより、Novateachでフォーチュン1000企業および中堅企業の平均アカウント価値を25%向上。','10万ドルから200万ドルのバジェットを持つエンタープライズ顧客のアカウントを管理,,オンボーディングから更新まで完全なアカウントライフサイクルを担当。'],
...
ko: {
  ...
  heroDesc:'12년 이상의 경력을 보유한 영업 및 사업 개발 리더로서 APAC, 북미, 중동, 영국, 호주 전역에서 수익 성장을 주도했습니다. Novatech에서 40% 매출 성장 달성, Medvocation에서 UAE 시장을 제로 기반으로 구축, 투자은행 분야에서 50개 이상의 동시 위임 업무를 관리했습니다. 기업 거래 개발, 경영진 관계 관리 및 다중 시장 파이프라인 실행 전문가입니다.',
  openToWork:'구직 중 · 즉시 입사 가능', btnViewExp:'경력 보기',
  stats:['연간 매출 성장률','고객 기반 확장','동시 위임 건수','경력 연수'],
  nav:['성과','경력','시장','연락처'],
  winsTitle:'중요한 숫자들', winsSub:'12년간 실제 직무에서 검증된 성과.',
  storyTitle:'나의 이야기',
  expTitle:'경력 사항', expSub:'투자 은행, SaaS, 의료 인력 및 아웃소싱에 걸친 5가지 경력. 상세 내용은 CV를 참조하세요.',
  ...
  er:['사업 개발 매니저','사업 개발 및 계정 관리자','국가 영업 및 사업 개발 매니저','프로젝트 매니저 및 사업 개발 이사','영업 및 사업 개발 임원'],
  ex:['500만~1억 달러 이상의 위임 업무에 대한 50개 이상의 잠재 고객 파이프라인을 구축하고 관리했습니다. 기술, 의료, 금융 서비스 전반의 창업자, CEO, CFO와의 C-레벨 참여를 이끌었습니다. Salesforce CRM을 사용해 85% 이상의 예측 정확도를 유지했습니다.','포춘 1000대 기업과 중간 시장 기업에 대한 아웃바운드 프로스펙팅을 통해 40% 연간 매출 성장을 달성했습니다. 85% 이상의 고객 유지율을 달성하고 구조화된 업셀 프로그램으로 평균 계정 가치를 25% 높였습니다.','18개월 만에 캐나다 고객 기반을 50% 확장했습니다. 영업 퍼널 재설계로 전환율을 35% 개선했습니다. 캐나다의 전체 수익 책임을 관리하면서 UAE 파이프라인을 제로에서 구축했습니다.','영국, 미국, 호주, UAE, APAC 전역에서 2년 내 글로벌 고객 기반을 두 배로 늘렸습니다. 여러 시간대에 걸쳐 교차 기능 팀을 이끌며 10만~200만 달러 예산의 기업 계정을 관리했습니다. 동시 클라이언트 참여 전반에 걸쳐 완전한 프로젝트 관리를 수행하면서 반복 수익을 창출하는 추천 네트워크를 구축했습니다.','연간 20% 판매 성장을 달성하고 가맹점 파트너십을 30% 성장시켰습니다. 5명의 주니어 영업팀을 멘토링하여 100% KPI 달성을 이끌었으며, 팀 성약률을 15% 개선했습니다.'],
...
es: {
  ...
  heroDesc:'Líder en ventas y desarrollo de negocios con más de 12 años impulsando ingresos en APAC, Norteamérica, Oriente Medio, Reino Unido y Australia. Logré un crecimiento de ingresos del 40% en Novatech, construí el pipeline de Emiratos Árabes desde cero en Medvocation y gestioné más de 50 mandatos simultáneos en banca de inversión. Especialista en originación de acuerdos empresariales, gestión de relaciones C-suite y ejecución de pipelines en múltiples mercados.',
  openToWork:'En búsqueda activa · Disponible ahora', btnViewExp:'Ver experiencia',
  stats:['Crecimiento de ingresos anual','Expansión de clientes','Mandatos simultáneos','Años de experiencia'],
  ...
  expTitle:'Trayectoria profesional', expSub:'Cinco roles en banca de inversión, SaaS, staffing sanitario y outsourcing. Detalles completos en el CV.',
...
fr: {
  ...
  heroDesc:"Leader commercial et développement des affaires avec plus de 12 ans d'expérience en croissance de chiffre d'affaires en APAC, Amérique du Nord, Moyen-Orient, Royaume-Uni et Australie. 40% de croissance chez Novatech, pipeline EAU construit de zéro chez Medvocation, et plus de 50 mandats simultanés gérés en banque d'investissement. Spécialiste de l'origination d'accords entreprises, de la gestion des relations C-suite et de l'exécution multi-marchés.",
  openToWork:"En recherche d'emploi · Disponible maintenant", btnViewExp:"Voir l'expérience",
  stats:['Croissance CA annuelle','Expansion clientèle','Mandats simultanés',"Années d'expérience"],
  ...
  expTitle:'Expérience professionnelle', expSub:"Cinq postes en banque d'investissement, SaaS, staffing médical et outsourcing. Détails complets dans le CV.",
  ...
  wt:['Croissance du CA annuel','Précision des prévisions de pipeline','Expansion de la clientèle','Amélioration du taux de conversion','Base clients mondiale doublée','Gamme de taille des deals','Croissance de la valeur des comptes','Budgets des comptes entreprises'],
  wd:["J'ai généré une croissance de 40% en glissement annuel chez Novatech grâce à un outbound ciblé et une planification stratégique des comptes auprès des entreprises Fortune 1000.",'J\'ai maintenu une précision de prévision supérieure à 85% sur un portefeuille de plus de 50 comptes chez CP Partners avec Salesforce CRM.',"J'ai augmenté la base clients santé canadienne de 50% en 18 mois chez Medvocation grâce à LinkedIn et des programmes de parrainage.",'J\'ai amélioré le taux de conversion lead-client de 35% en repensant le tunnel de vente et en utilisant les données pour supprimer les points de friction.',"J'ai doublé la base clients mondiale de Virtual Workforce Partners en 2 ans grâce à un outbound multicanal sur 5 marchés.",'J\'ai qualifié et géré des mandats en banque d\'investissement de 5M$ à plus de 100M$ couvrant M&A, conseil en capital et levées de fonds.',"J'ai augmenté la valeur moyenne des comptes de 25% chez Novatech grâce à des programmes structurés d'upsell et de cross-sell auprès des entreprises Fortune 1000 et mid-market.",'J\'ai géré des comptes clients d\'entreprise avec des budgets allant de 100K$ à 2M$, couvrant tout le cycle de vie du compte de l\'onboarding au renouvellement.'],
...
de: {
  ...
  heroDesc:'Vertriebs- und Geschäftsentwicklungsleiter mit über 12 Jahren Erfahrung in der Umsatzgenerierung in APAC, Nordamerika, dem Nahen Osten, Großbritannien und Australien. 40% Umsatzwachstum bei Novatech, VAE-Pipeline bei Medvocation von Grund auf aufgebaut und über 50 simultane Mandate im Investment Banking verwaltet. Spezialist für Enterprise-Deal-Origination, C-Suite-Beziehungsmanagement und Multi-Markt-Pipeline-Ausführung.',
  openToWork:'Offen für neue Stellen · Sofort verfügbar', btnViewExp:'Erfahrung ansehen',
  stats:['Jahresumsatzwachstum','Kundenbasis-Erweiterung','Simultane Mandate','Jahre Erfahrung'],
  ...
  expTitle:'Berufserfahrung', expSub:'Fünf Stellen in Investment Banking, SaaS, Healthcare-Staffing und Outsourcing. Vollständige Details im CV.',
...
it: {
  ...
  heroDesc:'Leader nelle vendite e nello sviluppo business con oltre 12 anni di esperienza nella crescita dei ricavi in APAC, Nord America, Medio Oriente, UK e Australia. Crescita del 40% dei ricavi da Novatech, pipeline EAU costruita da zero in Medvocation e oltre 50 mandati simultanei gestiti nell\'investment banking. Specialista in origination di accordi enterprise, gestione delle relazioni C-suite ed esecuzione multi-mercato.',
  openToWork:'In cerca di lavoro · Disponibile ora', btnViewExp:'Vedi esperienza',
  stats:['Crescita Ricavi Annuali','Espansione Clienti','Mandati Simultanei','Anni di Esperienza'],
  ...
  expTitle:'Esperienza lavorativa', expSub:'Cinque ruoli in investment banking, SaaS, healthcare staffing e outsourcing. Dettagli completi nel CV.',
...
nl: {
  ...
  heroDesc:'Verkoop- en bedrijfsontwikkelingsleider met meer dan 12 jaar ervaring in omzetgroei in APAC, Noord-Amerika, het Midden-Oosten, het VK en Australië. 40% omzetgroei bij Novatech gerealiseerd, VAE-pipeline bij Medvocation van nul opgebouwd en meer dan 50 gelijktijdige mandaten beheerd in investment banking. Specialist in enterprise deal origination, C-suite relatiebeheer en multi-markt pipeline executie.',
  openToWork:'Beschikbaar · Direct inzetbaar', btnViewExp:'Ervaring bekijken',
  stats:['Jaarlijkse Omzetgroei','Klantenbasis Uitbreiding','Gelijktijdige Mandaten','Jaren Ervaring'],
  ...
  expTitle:'Werkervaring', expSub:'Vijf functies in investment banking, SaaS, zorg staffing en outsourcing. Volledige details in het CV.',
  ...
  er:['Business Development Manager','Business Development & Account Manager','Country Sales & Business Development Manager','Projectmanager & Business Development Directeur','Sales & Business Development Executive'],
  ex:['Bouwde en beheerde een pipeline van 50+ prospects voor mandaten ter waarde van $5M tot $100M+. Stimuleerde C-suite betrokkenheid bij oprichters, CEO\'s en CFO\'s in technologie, gezondheidszorg en financiële dienstverlening. 85%+ prognose nauwkeurigheid gehandhaafd met Salesforce CRM.','Realiseerde 40% jaarlijkse omzetgroei via outbound prospectie bij Fortune 1000 en mid-market bedrijven. Bereikte 85%+ klantbehoud en groeide de gemiddelde accountwaarde met 25% via gestructureerde upsell programma\'s.','Breidde de Canadese klantenbasis met 50% uit in 18 maanden. Verbeterde conversie met 35% door het verkooptrechter opnieuw te ontwerpen. Bouwde de VAE-pipeline vanuit nul terwijl ik de volledige Canadese omzetverantwoordelijkheid beheerde.','Verdubbelde de wereldwijde klantenbasis in 2 jaar in UK, VS, Australië, VAE en APAC. Leidde cross-functionele leveringsteams over meerdere tijdzones, waarbij enterprise accounts met budgetten van $100K tot $2M werden beheerd. Bouwde referralnetwerken die terugkerende inkomsten genereerden terwijl ik volledig projectmanagement uitvoerde voor gelijktijdige klantbetrokkenheden.','Bereikte 20% jaarlijkse verkoopgroei en groeide merchant partnerships met 30%. Mentorde een 5-persoon junior verkoopteam naar 100% KPI-prestatie, wat teamsluitingspercentages verbeterde met 15%.'],
